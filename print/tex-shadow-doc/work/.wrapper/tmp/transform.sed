...
s|^-L/usr/pkg/packages/[^/ 	`"':;,]*\(/[^ 	`"':;,]*\)$|-L/usr/pkg\1|g
s|^/usr/pkg\(/[^ 	`"':;,]*\.la[ 	`"':;,]\)|_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^/usr/pkg\(/[^ 	`"':;,]*\.la\)$|_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^-I/usr/pkg\([ 	`"':;,]\)|-I_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^-I/usr/pkg$|-I_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#|g
s|^-I/usr/pkg\(/[^ 	`"':;,]*\)\([ 	`"':;,]\)|-I_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^-I/usr/pkg\(/[^ 	`"':;,]*\)$|-I_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^-L/usr/pkg\([ 	`"':;,]\)|-L_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^-L/usr/pkg$|-L_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#|g
s|^-L/usr/pkg\(/[^ 	`"':;,]*\)\([ 	`"':;,]\)|-L_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^-L/usr/pkg\(/[^ 	`"':;,]*\)$|-L_bUiLdLiNk__Volumes_Development_msk_NetBSD_pkgsrc-cvs_print_tex-shadow-doc_work_.buildlink#\1|g
s|^-I/[^ 	`"':;,]*\([ 	`"':;,]\)|\1|g
s|^-I/[^ 	`"':;,]*$||g
