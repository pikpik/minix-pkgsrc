/*	$NetBSD: util.c,v 1.2 2004/01/14 11:20:30 grant Exp $	*/
...
static char rcsid[] = "$NetBSD: util.c,v 1.2 2004/01/14 11:20:30 grant Exp $";
#else
#include <sys/cdefs.h>
#ifndef lint
__RCSID("$NetBSD: util.c,v 1.2 2004/01/14 11:20:30 grant Exp $");
#endif
#endif
